function goLogin() {
  ...
  function checkempty(){
     ...
     else if(document.getElementById('lnametxt').value==""){
         alert("กรุณาป้อนข้อมูลให้ครบถ้วน");
         document.getElementById('lnametxt').style.borderColor = "red";
         return false;
     }
     else if(document.getElementById('idtxt').value==""){
         alert("กรุณาป้อนข้อมูลให้ครบถ้วน");
     ...
     else if(document.getElementById('passwordtxt').value==""){
         alert("กรุณาป้อนข้อมูลให้ครบถ้วน");
         document.getElementById('passwordtxt').style.borderColor = "red";
         return false;
     }
     else if(document.getElementById('repasswordtxt').value==""){
         alert("กรุณาป้อนข้อมูลให้ครบถ้วน");
         document.getElementById('repasswordtxt').style.borderColor = "red";
         return false;  
  }
     else if(document.getElementById('passwordtxt').value != document.getElementById('repasswordtxt').value){
